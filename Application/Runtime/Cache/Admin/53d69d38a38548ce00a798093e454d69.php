...
<form id="submit" method="post" class="layui-form">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <select name="branch" class="branch" lay-filter="select">
        ...
        <?php if(is_array($branch)): $i = 0; $__LIST__ = $branch;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["uid"]); ?>"><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
      </select>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
     ...
     <div class="layui-form-mid layui-word-aux">.<?php echo ($SYSTEM_DOMAIN); ?></div>
     <div class="layui-form-mid layui-word-aux">例:(wp.<?php echo ($SYSTEM_DOMAIN); ?>,输入<font style="color: red;font-weight: bold;">wp</font>即可)</div>
  </div>

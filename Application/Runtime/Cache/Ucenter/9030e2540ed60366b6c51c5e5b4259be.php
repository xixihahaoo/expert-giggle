            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <table class="special_table_border table table-striped table-bordered">
                        ...
                        <tr>
                            <td class="center orange"><h4><b>&yen;<?php echo ($returnRs["account"]); ?></b></h4></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<!--                             <td class="center  hidden-480 orange"><h4><b>&yen;<?php echo ($returnRs["sell_commission"]); ?></b></h4></td> -->
...
<!--                             <td class="center  hidden-480 orange"><h4><b>&yen;<?php echo ($returnWeek["sell_commission"]); ?></b></h4></td> -->

...
/**
 * @author: RickyXie
 * @datetime: 20174/22 20:36
 * @filename: PositionsController.class.php
...
class PositionsController extends CommonController
{
    ...
    public function tlist()
    {
        ...
        $userlistRs    = M("UserinfoRelationship")->where($whereArr)->select();
        ...
        $agentinfoWhereArr  = 'uid in ('.implode(',', array_unique($userIdArr)).')';

        $userlist    = M("userinfo")->field("uid,username")->where($agentinfoWhereArr)->select();
        $this->assign('userlist',$userlist);

        $where['a.uid'] = array('in',$userIdStr);
